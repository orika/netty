...
//    void cacheSuccess(DnsQuestion question, AddressedEnvelope<? extends DnsResponse, InetSocketAddress> res) {
//        final int maxTtl = parent.maxTtl();
//        if (maxTtl == 0) {
//            return;
//        }
//
...
//        ttl = Math.max(parent.minTtl(), Math.min(maxTtl, ttl));
//
//        parent.cache(question, new DnsCacheEntry(res), ttl);
//    }
//
//    private void cacheFailure(DnsQuestion question, Throwable cause) {
